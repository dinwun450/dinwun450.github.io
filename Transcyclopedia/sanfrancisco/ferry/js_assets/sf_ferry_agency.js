...
function clearInfo() {
    ...
    document.getElementById("list_of_departures_ferry").innerHTML = `<li id="line_for_departure_ferry" class="lod_styling"><div class="wrapper_for_departure_ferry"><div id="line_for_each_departure_ferry">-</div> <span id="alerts_ferry"></span> <span id="route_headsign_ferry">(None)</span><span id="route_depart_ferry" class="departure_times_shift">Enter a specific station by their station ID, then select a ferry agency. <br> For GGF Departures, key in the GF: prefix, then their terminal id.</span></div></li>`
}
