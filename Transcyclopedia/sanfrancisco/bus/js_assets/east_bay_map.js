...
function moveItEastBay() {
    map.moveLayer('routes_bus', 'routes_bear_transit', 'routes_cccta', 'db_routes', 'delta_routes', 'union_city_routes', 'westcat_routes', 'wheels_routes');

    map.on('movestart', () => {
        map.setFilter('routes_bus', ['has', 'route_short_name']);
        map.setFilter('routes_bear_transit', ['has', 'route_short_name']);
        map.setFilter('routes_cccta', ['has', 'route_short_name']);
        map.setFilter('db_routes', ['has', 'route_short_name']);
        map.setFilter('delta_routes', ['has', 'route_short_name']);
        map.setFilter('union_city_routes', ['has', 'route_short_name']);
        map.setFilter('westcat_routes', ['has', 'route_short_name']);
    ...
    map.on('moveend', () => {
        const features = map.queryRenderedFeatures({
            layers: ['routes_bus', 'routes_bear_transit', 'routes_cccta', 'db_routes', 'delta_routes', 'union_city_routes', 'westcat_routes', 'wheels_routes']
        });
