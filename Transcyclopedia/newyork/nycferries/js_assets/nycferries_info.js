...
function changeNYCFerryAgency(a) {
    var nycferry_agency = a;

    switch(nycferry_agency) {
        case "nycferry":
            wikipedia_link_api = "https://en.wikipedia.org/w/api.php?format=json&action=query&prop=extracts&exintro&explaintext&redirects=1&titles=NYC_Ferry&origin=*";
            wikipedia_page_id = "51709291";
            foundedin = "May 1, 2017";
            onestop_id = "o-dr5r-nycferry";
            wikipedia_info = "https://en.wikipedia.org/wiki/NYC_Ferry";
            break;
        case "statenislandferry":
            wikipedia_link_api = "https://en.wikipedia.org/w/api.php?format=json&action=query&prop=extracts&exintro&explaintext&redirects=1&titles=Staten_Island_Ferry&origin=*";
            wikipedia_page_id = "301247";
            foundedin = "1817";
            onestop_id = "o-dr5r7-nycdot";
            wikipedia_info = "https://en.wikipedia.org/wiki/Staten_Island_Ferry";
            break;
        case "nycwaterway":
            wikipedia_link_api = "https://en.wikipedia.org/w/api.php?format=json&action=query&prop=extracts&exintro&explaintext&redirects=1&titles=NY_Waterway&origin=*";
            wikipedia_page_id = "1613034";
            foundedin = "December 3, 1986";
            onestop_id = "o-dr7-nywaterway";
            wikipedia_info = "https://en.wikipedia.org/wiki/NY_Waterway";
            break;
        default:
            wikipedia_link_api = "";
            wikipedia_page_id = "";
            ...
            document.getElementById("desc").innerHTML = "Select a NYC Ferry Agency.";
